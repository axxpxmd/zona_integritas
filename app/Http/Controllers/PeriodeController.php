...
class PeriodeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'tanggal_mulai_verifikasi' => 'nullable|date',
            'tanggal_selesai_verifikasi' => 'nullable|date|after_or_equal:tanggal_mulai_verifikasi',
            'tanggal_mulai_revisi' => 'nullable|date',
            'tanggal_selesai_revisi' => 'nullable|date|after_or_equal:tanggal_mulai_revisi',
            ...
            'tanggal_selesai_verifikasi.after_or_equal' => 'Tanggal selesai verifikasi tidak boleh mendahului tanggal mulai verifikasi.',
            'tanggal_selesai_revisi.after_or_equal' => 'Tanggal selesai revisi tidak boleh mendahului tanggal mulai revisi.',
