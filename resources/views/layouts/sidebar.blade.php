    ...
    <nav class="nav-wrapper flex-1 py-5 px-4 overflow-y-auto overflow-x-hidden">
        ...
        <div class="space-y-1.5">
            ...
            @if (in_array(Auth::user()->role, ['admin', 'verifikator']))
                ...
                <span class="sidebar-text transition-all duration-300 whitespace-nowrap">Verifikasi OPD</span>
            </a>
            @endif
        </div>
        ...
        <p class="section-label text-[10px] font-semibold text-white/40 uppercase tracking-wider mb-3 mt-6">Pengaturan Sistem</p>
        <div class="space-y-1.5">
        ...
        <p class="section-label text-[10px] font-semibold text-white/40 uppercase tracking-wider mb-3 mt-6">Struktur Kuesioner</p>
        <div class="space-y-1.5">
