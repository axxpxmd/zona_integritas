    ...
    <div class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="p-3 bg-blue-50 rounded-lg">
                    <p class="text-xs text-primary">
                        ...
                        @else
                        Verifikator Menpan memverifikasi hasil verifikator
                        @endif
                    </p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl p-6">
            ...
            <div class="space-y-2">
                ...
                <form action="{{ route('user.destroy', $user) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengguna ini?')">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
