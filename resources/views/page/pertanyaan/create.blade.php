...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">Tambah Pertanyaan</h2>
                    <p class="text-sm text-gray-600 mt-0.5">Tambah pertanyaan kuesioner baru</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('pertanyaan.store') }}" method="POST" class="bg-white rounded-xl p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="penjelasan"
                              ...
                              placeholder="Masukkan penjelasan atau petunjuk jawaban (opsional)">{{ old('penjelasan') }}</textarea>
                    @error('penjelasan')
                        <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select name="tipe_jawaban" id="tipe_jawaban"
                        ...
                        <option value="angka" {{ old('tipe_jawaban') == 'angka' ? 'selected' : '' }}>Angka</option>
...
idakInfo = document.getElementById('ya_tidak_info');
