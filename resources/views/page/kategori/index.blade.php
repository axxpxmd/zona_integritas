...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Data Kategori</h2>
            <p class="text-sm text-gray-600 mt-1">Kelola data kategori Zona Integritas</p>
        </div>
        ...
        <form method="GET" action="{{ route('kategori.index') }}" class="flex flex-col sm:flex-row gap-3">
            <div class="flex-1">
                <input type="text"
                       ...
                       placeholder="Cari nama, kode, komponen, atau deskripsi..."
            ...
            @if(request()->hasAny(['search', 'komponen_id', 'status']))
        ...
        <table class="w-full">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    ...
                    <th class="px-5 py-3.5 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Nama Kategori</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-5 py-4">
                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-medium bg-purple-100 text-purple-700">
                            {{ $kategori->komponen->kode }}
                        </span>
                        <p class="text-xs text-gray-500 mt-1">{{ $kategori->komponen->nama }}</p>
                    </td>
                    <td class="px-5 py-4">
                    ...
                    <td class="px-5 py-4">
                        ...
                        <p class="text-sm text-gray-500 mt-0.5 line-clamp-1">{{ $kategori->deskripsi }}</p>
                        @endif
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="text-sm font-semibold text-gray-900">{{ number_format($kategori->bobot, 2) }}%</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                        <span class="text-sm text-gray-700">{{ $kategori->urutan }}</span>
                    </td>
                    <td class="px-5 py-4 text-center">
                ...
                <tr>
                    <td colspan="7" class="px-5 py-12 text-center">
                        ...
                        <p class="text-sm text-gray-400 mt-1">Silakan tambah data kategori baru</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
        ...
        <div class="bg-white rounded-xl p-4 space-y-3">
            <div class="flex items-start justify-between gap-3">
                <div class="flex-1">
                    ...
                    <h3 class="font-semibold text-gray-900">{{ $kategori->nama }}</h3>
                    <p class="text-xs text-gray-500 mt-0.5">{{ $kategori->komponen->nama }}</p>
                </div>
                @if($kategori->status == 1)
            ...
            <div class="flex items-center gap-4 pt-2 border-t border-gray-100">
                <div class="flex items-center gap-1.5 text-sm">
                    ...
                    <span class="font-medium text-gray-900">{{ number_format($kategori->bobot, 2) }}%</span>
                </div>
                <div class="flex items-center gap-1.5 text-sm">
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"/>
                    </svg>
                    <span class="text-gray-600">Urutan: {{ $kategori->urutan }}</span>
                </div>
            </div>
