...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
            ...
            <p class="text-sm text-gray-600 mt-1">Perbarui data kategori</p>
        </div>
    ...
    <div class="max-w-3xl mx-auto">
        <form action="{{ route('kategori.update', $kategori) }}" method="POST" class="bg-white rounded-xl p-4 sm:p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="komponen_id" id="komponen_id"
                        ...
                        @foreach($komponens as $komp)
                            <option value="{{ $komp->id }}" {{ old('komponen_id', $kategori->komponen_id) == $komp->id ? 'selected' : '' }}>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi"
                              ...
                              class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none resize-none @error('deskripsi') border-red-300 @enderror">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
