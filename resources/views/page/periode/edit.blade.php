...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-lg font-semibold text-gray-900">Edit Periode</h2>
                <p class="text-sm text-gray-500">Perbarui data periode pengisian kuesioner</p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl">
        <form action="{{ route('periode.update', $periode) }}" method="POST" class="p-4 sm:p-6 space-y-5">
            @csrf
            @method('PUT')
