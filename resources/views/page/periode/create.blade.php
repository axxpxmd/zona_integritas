...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-xl font-bold text-gray-900">Tambah Periode Baru</h2>
            <p class="text-sm text-gray-500 mt-1">Buat periode pengisian kuesioner baru</p>
        </div>
    </div>

    {{-- Form Card --}}
    <div class="max-w-3xl">
        <form action="{{ route('periode.store') }}" method="POST" class="bg-white rounded-xl p-6 space-y-6">
            @csrf
