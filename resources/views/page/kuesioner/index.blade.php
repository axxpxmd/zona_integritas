...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-bold text-gray-900">Daftar Periode Lembar Kerja</h2>
            <p class="text-sm text-gray-500 mt-0.5">Pilih periode untuk mulai mengisi Lembar Kerja</p>
        </div>
    </div>
        ...
        <div class="flex gap-3">
            ...
            <div class="text-sm text-blue-800">
                ...
                <ul class="space-y-1 list-disc list-inside">
                    <li>Pilih periode yang tersedia untuk mulai mengisi Lembar Kerja</li>
