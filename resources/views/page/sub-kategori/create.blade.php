...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
            <h2 class="text-2xl font-bold text-gray-900">Tambah Sub Kategori</h2>
            <p class="text-sm text-gray-600 mt-1">Tambahkan data sub kategori baru</p>
        </div>
    ...
    <div class="max-w-3xl mx-auto">
        <form action="{{ route('sub-kategori.store') }}" method="POST" class="bg-white rounded-xl p-4 sm:p-6 space-y-6">
            @csrf
