    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Hanya Unit Kerja yang sudah dikirim oleh verifikator akan muncul di
                    sini.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl p-4">
            <form action="{{ route('verifikasi-menpan.index') }}" method="GET"
                ...
                @if ($activePeriode)
                    <div
                        ...
                        <span class="font-medium text-gray-900">Total Unit Kerja:</span> {{ $submittedOpds->count() }}
                    </div>
                @endif
            </form>
        </div>
                                        ...
                                        <td class="px-5 py-3 text-center">
                                            <div class="flex flex-col items-center justify-center gap-1.5">
                                                ...
                                                <span class="text-[10px] text-gray-500 font-medium">Terisi:
                                                    {{ $opd->total_jawaban }}/{{ $opd->total_jawaban }}</span>
                                            </div>
                                        </td>
